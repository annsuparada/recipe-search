...
export const getRecipes = (searchTerm) => async (dispatch) => {
  ...
  const localStorageKey = `/recipes/complexSearch?query=${searchTerm}&instructionsRequired=true&number=${listCount}&addRecipeNutrition=true&sort=popularity&apiKey=${API_KEY}`;
